...
VPATH += keyboards/edoball/keyboard_quantizer/parser

SRC += lib/Pico-PIO-USB/src/pio_usb.c
SRC += lib/Pico-PIO-USB/src/pio_usb_host.c
SRC += lib/Pico-PIO-USB/src/usb_crc.c
VPATH += keyboards/edoball/keyboard_quantizer/mini/lib/Pico-PIO-USB/src
...
VPATH += keyboards/edoball/keyboard_quantizer/mini/lib/tinyusb/src
